...
import { FaShoppingCart, FaWarehouse, FaCookie, FaChartBar, FaUsers, FaCrown } from 'react-icons/fa';
        ...
        <div className="max-w-7xl mx-auto flex items-center space-x-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-purple-100">
              Welcome, <span className="font-semibold">{user.fullName}</span>! You have full administrative access to all system features.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Manage employees, roles, attendance, and salaries.
            </p>
            <Link
              href="/employees"
